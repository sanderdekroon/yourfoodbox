...
@section('content')
	...
	<div class="row">
		...
		@foreach($orderLines as $orderLine)
			<div class="small-6 columns end">
				...
				<div class="row">
					...
					{!! Form::open(['method' => 'PATCH', 'url' => 'bestelling/', 'class' => 'small-3 columns']) !!}
		...
		@endforeach
			...
			<div class="small-6 columns end">
				<a class="button" href="{{action('OrdersController@confirmed')}}" title="Bestelling Plaatsen">Bestelling bevestigen</a>
			</div>
	</div>
